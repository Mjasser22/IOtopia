...
with warnings.catch_warnings():
    ...
    from distutils.# Check for Build issue
if '--with-unsupported-make-flags' in sysconfig.get_config_var("CONFIG_ARGS"):
    build_ext.build_extensions = lambda self : Nonecommand.build_ext import build_ext
